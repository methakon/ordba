    ...
    <div id="breadcrumb" class="division">
        ...
        <div class="row"> 
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo $search_key;?></li>
              </ol>
                        </nav>
          </div>
                    </div>
    ...
    <section id="news-3" class="pt-100 news-section division">
        ...
        <div class="row  "> 
           ...
           <div id="list_container" class="posts-holder pr-25  "> 
              <?php foreach($search_result as $k=>$topic ){ ?>            
                          <!-- ARTICLE #1 -->
              <div item_index="<?=$k+1?>" class="article-3 row d-flex align-items-center b-bottom  "> 
                ...
                <div class="col-md-8"> 
                              ...
                              <!-- Title -->
                              <h4 class="h4-sm"> <a href="<?=base_url($topic->page_location)?>"><?=$topic->name;?></a> </h4>
